...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[32m{bo}\x1b[33m[GURGA\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m] \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK\x1b[30m/\x1b[36mCP\x1b[33m]{bo} \x1b[32m{ok} / \x1b[36m{cp} \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]\033[0;36m "),
    sys.stdout.flush()
